...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM_H("DISABLE_OPTIMISTIC_HASH_JOIN", DISABLE_OPTIMISTIC_HASH_JOIN_HINT)},
    {SYM_H("SET_OPTIMISM_LEVEL", SET_OPTIMISM_LEVEL_HINT)},
    {SYM_H("SET_OPTIMISM_FUNC", SET_OPTIMISM_FUNC_HINT)}
};
